...
vim.keymap.set('n', 'n', 'nzzzv', { desc = 'keep cursor in middle when moving through searches' })
vim.keymap.set('n', 'N', 'Nzzzv', { desc = 'keep cursor in middle when moving through searches' })
vim.keymap.set('x', '<leader>p', '"_dP', { desc = 'preserve pasted register by deleting to the void buffer first' })
